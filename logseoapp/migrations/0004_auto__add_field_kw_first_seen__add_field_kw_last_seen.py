...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Kw.first_seen'
        db.add_column(u'kws', 'first_seen', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)

        # Adding field 'Kw.last_seen'
        db.add_column(u'kws', 'last_seen', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Kw.first_seen'
        db.delete_column(u'kws', 'first_seen')

        # Deleting field 'Kw.last_seen'
        db.delete_column(u'kws', 'last_seen')
